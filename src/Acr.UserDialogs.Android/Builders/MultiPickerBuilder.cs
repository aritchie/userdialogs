...
{
	public class MultiPickerBuilder : AbstractAlertDialogBuilder<MultiPickerPromptConfig>
	{
		public override AlertDialog.Builder Build(Activity activity, MultiPickerPromptConfig config)
		{
		...
		public override AppCompatAlertDialog.Builder Build(AppCompatActivity activity, MultiPickerPromptConfig config)
		{
			List<NumberPicker> pickers = new List<NumberPicker>();
