...
namespace Acr.UserDialogs
{
	...
	public interface IUserDialogs
	{
		...
		IDisposable PromptMultiInputs(PromptConfigMultiInput config);
		Task<PromptResultMultiInput> PromptAsyncMultiInputs(string message, List<PromptInput> promptInputs, string title = null, string okText = null, string cancelText = null, string placeholder = "", CancellationToken? cancelToken = null);
		Task<PromptResultMultiInput> PromptAsyncMultiInputs(PromptConfigMultiInput config, CancellationToken? cancelToken = null);
